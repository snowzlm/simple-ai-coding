...
这是一个面向 AI 编码代理的行为规范模板库，当前已对齐主流使用场景：

- **OpenClaw**：通过 `AGENTS.md` 直接加载规则
- **Codex**：通过 `AGENTS.md` 直接加载规则
- **Claude**：通过 `CLAUDE.md` 或 Claude 插件使用
