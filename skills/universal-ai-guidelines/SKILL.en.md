...
- This policy applies only to language materialization of this skill file (`SKILL.md`); it does not control global assistant conversation language and does not automatically override language policies of other downstream skills.
